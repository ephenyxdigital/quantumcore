...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      strLocal: "tr",
      strAdd: "Ekle",
      strAddColumn: "Sütun Ekle",
      strAddColLeft: "Sola sütun ekle",
      strAddColRight: "Sağa sütun ekle",
      strAddRow: "Satır Ekle",
      strAddRowAbove: "Yukarıya satır ekle",
      strAddRowBelow: "Aşağıya satır ekle",
      strAddRows: "{0} Satır Ekle",
      strAlignH: "Yatay hizalama",
      strAlignV: "Dikey hizalama",
      strAll: "Hepsi",
      strAND: "VE",
      strApply: "Uygula",
      strBlanks: "(Boş)",
      strBold: "Kalın",
      strBorder: "Sınır",
      strBorderColor: "Kenarlık Rengi",
      strBorderStyle: "Kenarlık Stili",
      strBottom: "Alt",
      strCancel: "İptal",
      strClear: "Temiz",
      strCollapse: "Daralt",
      ...
      strCut: "Kes",
      strDelete: "Sil",
      strDeleteColumn: "Sütunu Sil",
      strDeleteRow: "Satırı Sil",
      strEdit: "Düzenle",
      strExitFullScreen: "Tam Ekrandan Çık",
      strExpand: "Genişlet",
      strExport: "İhracat",
      strFillColor: "Dolgu Rengi",
      strFontSize: "Yazı tipi boyutu",
      strFontFamily: "Yazı tipi ailesi",
      strFormat: "Biçim",
      strFrozenCols: "Dondurulmuş Sütunlar",
      strFrozenRows: "Dondurulmuş Satırlar",
      strFullScreen: "Tam Ekran",
      ...
      strHide: "Gizle",
      strHideCols: "Sütunları Gizle",
      strHideRows: "Satırları Gizle",
      strHorizontal: "Yatay",
      strInner: "İç",
      strInsertColumn: "Sütun Ekle",
      strInsertRow: "Satır Ekle",
      strInsertRows: "{0} Satır Ekle",
      strImport: "İthalat",
      strImportImage: "Görüntüyü İçe Aktar",
      strItalic: "italik",
      strLabel: "Etiket",
      strLeft: "Sol",
      strLink: "Bağlantı",
      strLoading: "Yükleniyor",
      strLockCells: "Hücreleri kilitle",
      strMerge: "Birleştir",
      strMenu: {
        hideCols: "Görünür sütunlar",
        filter: "Filtre",
        export: "Dışa aktarılabilir sütunlar"
      },
      strName: "İsim",
      ...
      strRedo: "Yinele",
      strRename: "Yeniden adlandır",
      strRight: "Sağ",
      strSearch: "Ara",
      strSelectAll: "Hepsini Seç",
      strSelectedmatches: "{0} kayıttan {1} eşleşme",
      strShowCols: "Sütunları Göster",
      strShowRows: "Satırları Göster",
      strTextColor: "Metin Rengi",
      strTop: "Üst",
      strTabRemove: "{0} kalıcı olarak silinecek.\r\nEmin misin?",
      strTabName: "sheet{0}",
      strTabAdd: "Yeni sayfa",
      strTabClose: "Sayfayı kaldır",
      ...
      strUpdate: "Güncelleme",
      strUnhide: "Göster",
      strUnderline: "Altı çizili",
      strUndo: "Geri al",
      strUnmerge: "Ayır",
      strVertical: "Dikey",
      strWrap: "Metni Sar",
      strFormulas: {
        ...
        SUM: ["SUM(sayı1,[sayı2],...)", "Argümanlarını ekler. Tek tek değerler, hücre referansları veya aralıkları veya her üçünün bir karışımını ekleyebilirsiniz."],
