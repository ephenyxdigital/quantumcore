...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      strLocal: "ru",
      strAdd: "Добавить",
      strAddColumn: "Добавить столбец",
      strAddColLeft: "Добавить столбец слева",
      strAddColRight: "Добавить столбец справа",
      strAddRow: "Добавить строку",
      strAddRowAbove: "Добавить строку выше",
      strAddRowBelow: "Добавить строку ниже",
      strAddRows: "Добавить {0} строк",
      strAlignH: "Горизонтальное выравнивание",
      strAlignV: "Вертикальное выравнивание",
      strAll: "Все",
      strAND: "И",
      strApply: "Применить",
      strBlanks: "(Пробелы)",
      strBold: "Жирный",
      strBorder: "Граница",
      strBorderColor: "Цвет границы",
      strBorderStyle: "Стиль границы",
      strBottom: "Внизу",
      strCancel: "Отмена",
      strClear: "Очистить",
      strCollapse: "Свернуть",
      ...
      strCut: "Вырезать",
      strDelete: "Удалить",
      strDeleteColumn: "Удалить столбец",
      strDeleteRow: "Удалить строку",
      strEdit: "Изменить",
      strExitFullScreen: "Выйти из полноэкранного режима",
      strExpand: "Развернуть",
      strExport: "Экспорт",
      strFillColor: "Цвет заливки",
      strFontSize: "Размер шрифта",
      strFontFamily: "Семейство шрифтов",
      strFormat: "Формат",
      strFrozenCols: "Замороженные колонны",
      strFrozenRows: "Замороженные строки",
      strFullScreen: "Полный экран",
      strGroup_header: "Удалить группу по столбцу",
      strGroup_merge: "Объединить ячейки",
      strGroup_fixCols: "Исправить столбцы",
      strGroup_grandSummary: "Общее резюме",
      strHide: "Скрыть",
      strHideCols: "Скрыть столбцы",
      strHideRows: "Скрыть строки",
      strHorizontal: "Горизонтальный",
      strInner: "Внутренний",
      strInsertColumn: "Вставить столбец",
      strInsertRow: "Вставить строку",
      strInsertRows: "Вставить {0} строк",
      strImport: "Импорт",
      strImportImage: "Импортировать изображение",
      strItalic: "Курсив",
      strLabel: "Этикетка",
      strLeft: "Левый",
      strLink: "Ссылка",
      strLoading: "Загрузка",
      strLockCells: "Замковые ячейки",
      strMerge: "Объединить",
      strMenu: {
        hideCols: "Видимые столбцы",
        filter: "Фильтр",
        export: "Экспортируемые столбцы"
      },
      strName: "Имя",
      ...
      strShowCols: "Показать столбцы",
      strShowRows: "Показать строки",
      strTextColor: "Цвет текста",
      strTop: "Топ",
      strTabRemove: "{0} будет удален навсегда.\r\nВы уверены?",
      strTabName: "sheet{0}",
      strTabAdd: "Новый лист",
      strTabClose: "Удалить лист",
      strTP_aggPane: "Агрегаты",
      strTP_colPane: "Группировать столбцы",
      strTP_pivot: "Режим поворота",
      strTP_rowPane: "Группировать строки",
      strTP_aggPH: "Удаление столбцов для агрегатов",
      strTP_colPH: "Удаление столбцов для группировки столбцов",
      strTP_rowPH: "Удаление столбцов для группировки строк",
      strUpdate: "Обновить",
      strUnhide: "Показать",
      strUnderline: "Подчеркнуть",
      strUndo: "Отменить",
      strUnmerge: "Разъединить",
      strVertical: "Вертикальный",
      strWrap: "Перенос текста",
      strFormulas: {
