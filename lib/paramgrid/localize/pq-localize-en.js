...
var pq = $.paramquery, 
    ...
    grid = pq.strings = pq.pqGrid.regional[local]={
        ...
        strAddColLeft: 'Add column left',
        strAddColRight: 'Add column right',
        strAddRow: 'Add Row',
        strAddRowAbove: 'Add row above',
        strAddRowBelow: 'Add row below',
        strAddRows: 'Add {0} Rows',
        strAlignH: 'Horizontal alignment',
        strAlignV: 'Vertical alignment',
        strAll: 'All',
        strAND: 'AND',
        strApply: 'Apply',
        strBlanks: "( Blanks )",
        ...
        strCut: 'Cut',
        strDelete: "Delete",
        strDeleteColumn: 'Delete Column',
        strDeleteRow: 'Delete Row',
        strEdit: "Edit",
        strExitFullScreen: 'Exit Full Screen',
        strExpand: 'Expand',
        strExport: 'Export',
        strFillColor: 'Fill Color',
        strFontSize: 'Font size',
        strFontFamily: 'Font family',
        strFormat: "Format",
        strFrozenCols: 'Frozen Columns',
        strFrozenRows: 'Frozen Rows',
        strFullScreen: 'Full Screen',
        strGroup_header: "Drop group by column",
        strGroup_merge: 'Merge cells',
        strGroup_fixCols: 'Fix columns',
        strGroup_grandSummary: 'Grand summary',
        strHide: 'Hide',
        strHideCols: 'Hide Columns',
        strHideRows: 'Hide Rows',
        strHorizontal: 'Horizontal',
        strInner: 'Inner',
        strInsertColumn: 'Insert Column',
        strInsertRow: 'Insert Row',
        strInsertRows: 'Insert {0} Rows',
        strImport: 'Import',
        strImportImage: 'Import Image',
        strItalic: "Italic",
        strLabel: 'Label',
        strLeft:'Left',
        strLink: "Link",
        strLoading: "Loading",
        strLockCells: "Lock cells",
        strMerge: 'Merge',
        strMenu:{
            hideCols: 'Visible columns',
            filter: 'Filter',
            export: 'Exportable columns'
        },
        strName: 'Name',        
        ...
        strShowRows: 'Show Rows',
        strTextColor: 'Text Color',
        strTop:'Top',
        ...
        strTP_aggPH: "Drop columns for aggregates",
        strTP_colPH: "Drop columns for column grouping",
        strTP_rowPH: "Drop columns for row grouping",
        strUpdate: 'Update',        
        strUnhide: 'Unhide',
