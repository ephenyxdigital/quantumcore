...
if (shortcode_custom_css_has_property($css, ['border', 'background']) || $video_bg || $parallax) {
...
if (!empty($parallax)) {
	...
	} else if (false !== strpos($parallax, 'fixed')) {
...
$hook_args = ['atts' => $atts, 'base' => $this->settings['base'], 'css_classes' => ''];
