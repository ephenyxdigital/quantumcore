...
class ComposerFontContainer extends Composer {
		...
		if (!empty($fields)) {
			...
			if (isset($fields['tag'])) {
                ...
                <div class="vc_row-fluid vc_shortcode-param vc_column">
                    <div class="wpb_element_label">' . $this->l('Element tag') . '</div>
                    <div class="font_container_form_field-tag-container">
                        <select class="font_container_form_field-tag-select">';
			...
			if (isset($fields['font_size'])) {
				$data['font_size'] = '
                <div class="vc_row-fluid vc_shortcode-param vc_column">
                    <div class="wpb_element_label">' . $this->l('Font size') . '</div>
                    <div class="font_container_form_field-font_size-container">
                        <input class="font_container_form_field-font_size-input" type="text" value="' . $values['font_size'] . '" />
                    </div>';
			...
			if (isset($fields['text_align'])) {
				$data['text_align'] = '
                <div class="vc_row-fluid vc_shortcode-param vc_column">
                    <div class="wpb_element_label">' . $this->l('Text align') . '</div>
                    <div class="font_container_form_field-text_align-container">
                        <select class="font_container_form_field-text_align-select">
                            <option value="left" class="left" ' . ($values['text_align'] == 'left' ? 'selected="selected"' : '') . '>' . $this->l('left') . '</option>
                            <option value="right" class="right" ' . ($values['text_align'] == 'right' ? 'selected="selected"' : '') . '>' . $this->l('right') . '</option>
                            <option value="center" class="center" ' . ($values['text_align'] == 'center' ? 'selected="selected"' : '') . '>' . $this->l('center') . '</option>
                            <option value="justify" class="justify" ' . ($values['text_align'] == 'justify' ? 'selected="selected"' : '') . '>' . $this->l('justify') . '</option>
                        </select>
                    </div>';
			...
			if (isset($fields['line_height'])) {
				$data['line_height'] = '
                <div class="vc_row-fluid vc_shortcode-param vc_column">
                    <div class="wpb_element_label">' . $this->l('Line height') . '</div>
                    <div class="font_container_form_field-line_height-container">
                        <input class="font_container_form_field-line_height-input"  type="text"  value="' . $values['line_height'] . '" />
                    </div>';
			...
			if (isset($fields['color'])) {
				$data['color'] = '
                <div class="vc_row-fluid vc_shortcode-param vc_column">
                    <div class="wpb_element_label">' . $this->l('Text color') . '</div>
                    <div class="font_container_form_field-color-container">
                        <div class="color-group">
                            <input type="text" value="' . $values['color'] . '" class="font_container_form_field-color-input vc_color-control" />
                        </div>
                    </div>';
			...
			if (isset($fields['font_family'])) {
				$data['font_family'] = '
                <div class="vc_row-fluid vc_shortcode-param vc_column">
                    <div class="wpb_element_label">' . $this->l('Font Family') . '</div>
                    <div class="font_container_form_field-font_family-container">
                        <select class="font_container_form_field-font_family-select">';
				$fonts = $this->_vc_font_container_get_web_safe_fonts();

				foreach ($fonts as $font_name => $font_data) {
					$data['font_family'] .= '<option value="' . $font_name . '" class="' . build_safe_css_class($font_name) . '" ' . (strtolower($values['font_family']) == strtolower($font_name) ? 'selected="selected"' : '') . ' data[font_family]="' . urlencode($font_data) . '">' . $font_name . '</option>';
				}
			...
			if (isset($fields['font_style'])) {
				$data['font_style'] = '
                <div class="vc_row-fluid vc_shortcode-param vc_column">
                    <div class="wpb_element_label">' . $this->l('Font style') . '</div>
                    <div class="font_container_form_field-font_style-container">
                        <label>
                            <input type="checkbox" class="font_container_form_field-font_style-checkbox italic" value="italic" ' . ($values['font_style_italic'] == "1" ? 'checked="checked"' : '') . '><span class="font_container_form_field-font_style-label italic">' . $this->l('italic') . '</span>
                         </label>
                        <br />
                        <label>
                            <input type="checkbox" class="font_container_form_field-font_style-checkbox bold" value="bold" ' . ($values['font_style_bold'] == "1" ? 'checked="checked"' : '') . '><span class="font_container_form_field-font_style-label bold">' . $this->l('bold') . '</span>
                        </label>
                    </div>';
