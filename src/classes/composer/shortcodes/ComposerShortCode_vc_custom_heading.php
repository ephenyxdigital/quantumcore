...
class ComposerShortCode_vc_custom_heading extends ComposerShortCode {
	...
	public function getAttributes($atts) {
		 ...
		 **/
		$google_fonts_field = ComposerMap::getParam('vc_custom_heading', 'google_fonts');
		$font_container_field = ComposerMap::getParam('vc_custom_heading', 'font_container');
		$el_class_field = ComposerMap::getParam('vc_custom_heading', 'el_class');
		$css_field = ComposerMap::getParam('vc_custom_heading', 'css');
		$text_field = ComposerMap::getParam('vc_custom_heading', 'text');
		...
		$font_container_obj = new ComposerFontContainer();
		$google_fonts_obj = new ComposerGoogleFonts();
	...
	public function getStyles($el_class, $css, $google_fonts_data, $font_container_data, $atts) {
		...
		$css_class = 'vc_custom_heading wpb_content_element' . $el_class . shortcode_custom_css_class($css, ' ');
