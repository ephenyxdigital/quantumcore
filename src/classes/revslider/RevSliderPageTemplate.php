...
class RevSliderPageTemplate {
	...
	private function __construct() {
		...
		// Fix for WP 4.7
		RevLoader::add_filter('theme_page_templates', [$this, 'register_project_templates_new']);
		...
		foreach ($types as $type => $values) {
			...
			if (isset($type)) {
				...
				RevLoader::add_filter($type_name, [$this, 'add_post_templates']);
			}
