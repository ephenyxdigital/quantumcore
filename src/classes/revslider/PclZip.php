    ...
    for ($i = 0, $v_nb_extracted = 0; $i < $v_central_dir['entries']; $i++) {
      ...
      if ((isset($p_options[PCLZIP_OPT_BY_NAME]))
        ...
        for ($j = 0; ($j < sizeof($p_options[PCLZIP_OPT_BY_NAME])) && (!$v_extract); $j++) {
          ...
          if ($v_header['stored_filename'] == $p_options[PCLZIP_OPT_BY_NAME][$j]) {
            $v_extract = true;
          }
...
*/
      ...
      if ($v_extract) {
        ...
        if ((isset($p_options[PCLZIP_OPT_EXTRACT_IN_OUTPUT]))
      ...
      if ((isset($p_options[PCLZIP_OPT_BY_NAME]))
        ...
        for ($j = 0; ($j < sizeof($p_options[PCLZIP_OPT_BY_NAME])) && (!$v_found); $j++) {
          ...
          if (substr($p_options[PCLZIP_OPT_BY_NAME][$j], -1) == "/") {
            ...
            if ((($v_header_list[$v_nb_extracted]['external'] & 0x00000010) == 0x00000010) /* Indicates a folder */
          ...
          if ($v_header_list[$v_nb_extracted]['stored_filename'] == $p_options[PCLZIP_OPT_BY_NAME][$j]) {
            $v_found = true;
          }
